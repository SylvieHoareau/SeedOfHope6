...
public class PlayerHealth : MonoBehaviour
{
    ...
    public void TakeDamage(int damage)
    {
        ...
        else
        {
            ...
            // On évite de lancer plusieurs coroutines de clignotement
    ...
    // Coroutine pour attendre avant de charger la scène GameOver
    ...
    public IEnumerator HandleInvincibilityDelay()
    {
        ...
        isInvincible = false;
        // On arrête la coroutine de clignotement à la fin de l'invincibilité
        if (invincibilityFlashCoroutine != null)
        {
            StopCoroutine(invincibilityFlashCoroutine);
            invincibilityFlashCoroutine = null;
        }
        // On s'assure que le joueur redevient visible
        if (graphics != null)
